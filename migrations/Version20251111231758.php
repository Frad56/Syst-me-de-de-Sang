 ...
 */
final class Version20251111231758 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rendez_vous ADD CONSTRAINT FK_65E8AA0A3CA200B5 FOREIGN KEY (liste_collectes_id) REFERENCES collecte (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
