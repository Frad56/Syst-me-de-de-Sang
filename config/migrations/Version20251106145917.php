 ...
 */
final class Version20251106145917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE don (id INT AUTO_INCREMENT NOT NULL, donateur_id_id INT DEFAULT NULL, rendez_vous_id INT NOT NULL, datedon DATE NOT NULL, quantite INT NOT NULL, type_don VARCHAR(255) NOT NULL, apte TINYINT(1) NOT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_F8F081D9FDFECE7 (donateur_id_id), UNIQUE INDEX UNIQ_F8F081D991EF7EAA (rendez_vous_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE lieu (id INT AUTO_INCREMENT NOT NULL, nom_lieu VARCHAR(50) NOT NULL, adresse VARCHAR(30) DEFAULT NULL, ville VARCHAR(40) DEFAULT NULL, code_postal INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, groupe_sanguin VARCHAR(40) NOT NULL, niveau_actuel VARCHAR(30) NOT NULL, niveau_alerte VARCHAR(30) NOT NULL, dernier_mise_ajour DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
